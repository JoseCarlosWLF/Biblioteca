...
public class FormularioDevolucion extends javax.swing.JFrame {
    ...
    private void jButtonDevolverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDevolverActionPerformed
        ...
        String sqlSelect = "SELECT id_prestamo, id_usuario FROM Prestamo WHERE id_libro = ?";
        ...
        try{
            ...
            if (rs.next()) {
                ...
                JOptionPane.showMessageDialog(this, manejador.registrarDevolucion(idPrestamo, idUsuario, idLibroInt));
            }else{
